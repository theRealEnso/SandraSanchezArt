   ...
   */ const params = renderOpts.params ?? {};
    ...
    const renderToStream = (0, _tracer.getTracer)().wrap(_constants.AppRenderSpan.getBodyResult, {
        ...
        try {
            ...
            const shouldBailoutToCSR = (0, _nossrerror.isBailoutCSRError)(err);
    ...
    // not rendered.
    if (renderOpts.experimental.ppr && staticGenerationStore.postponeWasTriggered && !metadata.postponed && (!response.err || !(0, _nossrerror.isBailoutCSRError)(response.err))) {
