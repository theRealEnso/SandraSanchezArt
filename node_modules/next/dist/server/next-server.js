...
class NextNodeServer extends _baseserver.default {
    ...
    async getIncrementalCache({ requestHeaders, requestProtocol }) {
        ...
        if (incrementalCacheHandlerPath) {
            CacheHandler = (0, _interopdefault.interopDefault)(await dynamicImportEsmDefault((0, _formatdynamicimportpath.formatDynamicImportPath)(this.distDir, incrementalCacheHandlerPath)));
        }
