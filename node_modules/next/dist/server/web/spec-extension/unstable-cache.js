...
async function cacheNewResult(result, incrementalCache, cacheKey, tags, revalidate) {
...
function unstable_cache(cb, keyParts, options = {}) {
    ...
    const cachedCb = async (...args)=>{
        ...
        if (store) {
                    ...
                    // will fall through to generating a new cache entry below
                        ...
                        if (cacheEntry.isStale) {
                            ...
                            store.pendingRevalidates[invocationKey] = staticGenerationAsyncStorage.run({
                                ...
                                return cacheNewResult(result, incrementalCache, cacheKey, tags, options.revalidate);
            ...
            cacheNewResult(result, incrementalCache, cacheKey, tags, options.revalidate);
            return result;
        } else {
