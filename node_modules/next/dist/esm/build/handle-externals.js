...
export async function resolveExternal(dir, esmExternalsConfig, context, request, isEsmRequested, optOutBundlingPackages, getResolve, isLocalCallback, baseResolveCheck = true, esmResolveOptions = NODE_ESM_RESOLVE_OPTIONS, nodeResolveOptions = NODE_RESOLVE_OPTIONS, baseEsmResolveOptions = NODE_BASE_ESM_RESOLVE_OPTIONS, baseResolveOptions = NODE_BASE_RESOLVE_OPTIONS) {
...
export function makeExternalHandler({ config, optOutBundlingPackages, optOutBundlingPackageRegex, dir }) {
     ...
     */ const resolveNextExternal = (localRes)=>{
        ...
        if (layer === WEBPACK_LAYERS.serverSideRendering) {
            ...
            const fullRequest = isRelative ? normalizePathSep(path.join(context, request)) : request;
