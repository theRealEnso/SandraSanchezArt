    ...
    const getEntryHandler = (mappings, pagesType)=>async (page)=>{
            ...
            runDependingOnPageType({
                ...
                onServer: ()=>{
                    ...
                    } else if (isInstrumentationHookFile(page) && pagesType === PAGE_TYPES.ROOT) {
                ...
                onEdgeServer: ()=>{
                    ...
                    const normalizedServerBundlePath = isInstrumentationHookFile(page) && pagesType === PAGE_TYPES.ROOT ? serverBundlePath.replace("src/", "") : serverBundlePath;
