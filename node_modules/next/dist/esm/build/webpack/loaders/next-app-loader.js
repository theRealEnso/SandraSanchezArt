        ...
        for (const [parallelKey, parallelSegment] of parallelSegments){
          ...
          ${createMetadataExportsCode(metadata)}
            ...
            if (!rootLayout) {
                ...
                if (layoutPath) {
                    const resolvedGlobalErrorPath = await resolver(`${path.dirname(layoutPath)}/${GLOBAL_ERROR_FILE_TYPE}`);
        ...
        for (const adjacentParallelSegment of adjacentParallelSegments){
            if (!props[normalizeParallelKey(adjacentParallelSegment)]) {
                ...
                if (!defaultPath) {
                    ...
                    const normalizedDefault = await resolver(`${appDirPrefix}${normalizeAppPath(segmentPath)}/${actualSegment}/default`);
