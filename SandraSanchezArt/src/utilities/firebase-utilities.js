...
import { getFirestore, doc, getDoc, setDoc, collection, writeBatch, query, getDocs } from 'firebase/firestore'; // doc gets document instance, getDoc gets data inside a document instance. Likewise, setDoc function only sets the data inside a document. The doc function is what allows us to get the entire document instance (super confusing naming convention!)
...
export const addCollectionAndDocuments = async (collectionName, productObjectsToAdd) => {
...
// https://firebase.google.com/docs/firestore/manage-data/add-data
export const createUserDocOrSignInUserFromAuth = async (authObj, additionalName = {}) => {
...
export const onUserAuthStateChangedListener = (callbackFunc) => onAuthStateChanged(auth, callbackFunc);
