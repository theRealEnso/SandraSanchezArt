 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QJ{constructor(t,n){this.indexManager=t,this.referenceDelegate=n,this.mutationQueue=[],this.pr=1,this.yr=new It(ut.Pr)}checkEmpty(t){return A.resolve(this.mutationQueue.length===0)}addMutationBatch(t,n,r,i){const o=this.pr;this.pr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const s=new vJ(o,n,r,i);this.mutationQueue.push(s);for(const a of i)this.yr=this.yr.add(new ut(a.key,o)),this.indexManager.addToCollectionParentIndex(t,a.key.path.popLast());return A.resolve(s)}lookupMutationBatch(t,n){return A.resolve(this.wr(n))}getNextMutationBatchAfterBatchId(t,n){const r=n+1,i=this.Sr(r),o=i<0?0:i;return A.resolve(this.mutationQueue.length>o?this.mutationQueue[o]:null)}getHighestUnacknowledgedBatchId(){return A.resolve(this.mutationQueue.length===0?-1:this.pr-1)}getAllMutationBatches(t){return A.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,n){const r=new ut(n,0),i=new ut(n,Number.POSITIVE_INFINITY),o=[];return this.yr.forEachInRange([r,i],s=>{const a=this.wr(s.gr);o.push(a)}),A.resolve(o)}getAllMutationBatchesAffectingDocumentKeys(t,n){let r=new It(de);return n.forEach(i=>{const o=new ut(i,0),s=new ut(i,Number.POSITIVE_INFINITY);this.yr.forEachInRange([o,s],a=>{r=r.add(a.gr)})}),A.resolve(this.br(r))}getAllMutationBatchesAffectingQuery(t,n){const r=n.path,i=r.length+1;let o=r;W.isDocumentKey(o)||(o=o.child(""));const s=new ut(new W(o),0);let a=new It(de);return this.yr.forEachWhile(l=>{const u=l.key.path;return!!r.isPrefixOf(u)&&(u.length===i&&(a=a.add(l.gr)),!0)},s),A.resolve(this.br(a))}br(t){const n=[];return t.forEach(r=>{const i=this.wr(r);i!==null&&n.push(i)}),n}removeMutationBatch(t,n){Ee(this.Dr(n.batchId,"removed")===0),this.mutationQueue.shift();let r=this.yr;return A.forEach(n.mutations,i=>{const o=new ut(i.key,n.batchId);return r=r.delete(o),this.referenceDelegate.markPotentiallyOrphaned(t,i.key)}).next(()=>{this.yr=r})}Fn(t){}containsKey(t,n){const r=new ut(n,0),i=this.yr.firstAfterOrEqual(r);return A.resolve(n.isEqual(i&&i.key))}performConsistencyCheck(t){return this.mutationQueue.length,A.resolve()}Dr(t,n){return this.Sr(t)}Sr(t){return this.mutationQueue.length===0?0:t-this.mutationQueue[0].batchId}wr(t){const n=this.Sr(t);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,ht={default:"default",google:"google"},Xee=(e=ht.default)=>({[ht.default]:$2,[ht.google]:Qee})[e],Yn=({buttonType:e,...t})=>{const n=Xee(e);return w.jsx(n,{...t})},Jee=k.div`
    display: flex;
    justify-content: space-evenly;
    width: 80%;
    margin: auto;
...
`,Wre=k.span`
    color: rgb(255, 51, 153);
    font-weight: bold;
`,Hre=()=>{const e=Vi(),{currentUser:t,setCurrentUser:n}=S.useContext(gc),[r,i]=S.useState({email:"",password:""}),{email:o,password:s}=r,a=f=>{const{name:d,value:p}=f.target;i({...r,[d]:p})},l=()=>{i({email:"",password:""})},u=async f=>{f.preventDefault();try{const d=await $ee(o,s);if(console.log(d),d){const{user:p}=d;n(p)}}catch(d){console.log(`There was an error signing in: ${d}`)}l()},c=async()=>{try{const f=await Oee();if(console.log(f),f){const{user:d}=f;await M_(d),n(d)}}catch(f){console.log(f)}};return t&&e("/"),w.jsxs(zre,{children:[w.jsx("h2",{children:"Already have an account?"}),w.jsx(Wre,{children:"Sign in with your email and password"}),w.jsxs("form",{onSubmit:u,children:[w.jsx(_s,{label:"email",type:"email",name:"email",value:o,required:!0,onChange:a}),w.jsx(_s,{label:"password",type:"password",name:"password",value:s,required:!0,onChange:a}),w.jsxs(Bre,{children:[w.jsx(Yn,{buttonType:ht.default,children:"Sign In With Email"}),w.jsx(Yn,{buttonType:ht.google,type:"submit",onClick:c,children:"Sign In With Google"})]})]})]})},qre=k.div`
    display: flex;
    justify-content: space-between;
    width: 70%;
    margin: 30px auto;
...
`,_oe=k(L_)`
    width: 10%;
`,woe=({cartItem:e})=>{const{imageUrl:t,itemPrice:n,name:r,quantity:i,selectedSize:o,id:s,key:a}=e,{cartItems:l,setCartItems:u,addOneItemToCart:c,removeOneItemFromCart:f}=S.useContext(Uo),d=m=>{const _=m.target.value,v=l.find(h=>h.id===s&&h.selectedSize===o&&h.key===a);if(/^\d*$/.test(_)&&v){const h=l.map(y=>y.id===s&&y.selectedSize===o&&y.key===a?{...y,quantity:_===""?"":parseInt(_,10)}:y);u(h)}},p=()=>f(e,o,a),g=()=>c(e,o,a);return w.jsxs(moe,{children:[w.jsx(goe,{children:w.jsx("img",{src:t,alt:r})}),w.jsxs(voe,{children:[w.jsx("h2",{children:r}),w.jsx("h4",{children:o})]}),w.jsxs(_oe,{children:[w.jsx(oa,{buttonType:ht.default,onClick:p,children:"-"}),w.jsx(j_,{type:"number",value:i,onChange:d}),w.jsx(oa,{buttonType:ht.default,onClick:g,children:"+"})]}),w.jsx(yoe,{children:w.jsxs("span",{children:["$ ",i*n]})})]})},Eoe=()=>{const e=Vi(),{cartItems:t,cartTotal:n}=S.useContext(Uo),r=()=>e("/"),i=()=>e("/checkout");return w.jsxs(uoe,{children:[w.jsxs(coe,{children:[w.jsx("h1",{children:"SHOPPING CART"}),w.jsx(foe,{children:t.map(o=>w.jsx(woe,{cartItem:o},o.key))})]}),w.jsxs("span",{children:["Sub-total: $ ",n]}),w.jsxs(doe,{children:[w.jsx(poe,{buttonType:ht.default,onClick:r,children:"Return to Home"}),w.jsx(hoe,{buttonType:ht.google,onClick:i,children:"Checkout"})]})]})},FN=bo`
  top: 2px;
  font-size: 10px;
`,Soe=k.div`
  position: relative;
...
`;const Koe=()=>w.jsxs(Goe,{children:[w.jsx("h2",{children:"Credit Card Payment:"}),w.jsx(Ek,{}),w.jsx(qoe,{buttonType:ht.google,children:"PAY NOW"})]});k(Yn)`
    font-size: 20px;
    border-radius: 2.5px;
`;const Yoe=k.div`
    display: flex;
...
`,Qoe=k.form`
    height: 100px;
    min-width: 500px;
`,Xoe=()=>{const[e,t]=S.useState("");return wk(),_k(),S.useEffect(()=>{const n=fetch("/.netlify/functions/create-payment-intent",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({amount:1e4})}).then(r=>r.json()).then(r=>{console.log(r);const{paymentIntent:{client_secret:i}}=r;console.log(i),t(i)});console.log(n)},[]),w.jsx(Yoe,{children:w.jsxs(Qoe,{children:[w.jsx(F4,{}),w.jsx("button",{id:"submit",children:"Submit"})]})})},Joe=()=>{const{currentUser:e}=S.useContext(gc),t=S.useRef(null),n=S.useRef(null),[r,i]=S.useState(!1),[o,s]=S.useState(!1),[a,l]=S.useState(VI),[u,c]=S.useState("United States"),[f,d]=S.useState(""),[p,g]=S.useState(Hoe),[m,_]=S.useState("California"),[v,h]=S.useState(a),[y,E]=S.useState({email:"",firstName:"",lastName:"",company:"",streetAddress:"",city:"",state:"",zipOrPostalCode:"",additionalAddress:""}),{email:T,firstName:I,lastName:b,company:R,streetAddress:j,city:O,state:ue,zipOrPostalCode:ye,additionalAddress:Le}=y,[Be,_n]=S.useState(!1),wn=()=>i(!r),_e=()=>s(!o),$=()=>_n(!Be),D=X=>{const{name:lt,value:sn}=X.target;E({...y,[lt]:sn})},H=X=>{X.stopPropagation(),X.preventDefault(),wn()},se=X=>{X.preventDefault(),X.stopPropagation(),_e()},ae=X=>{d(X.target.value)},on=X=>{X.stopPropagation();const lt=X.target.textContent;c(lt||""),i(!1),d("")},st=X=>{X.stopPropagation();const lt=X.target.textContent;_(lt),s(!1)},En=()=>{E({email:"",firstName:"",lastName:"",company:"",streetAddress:"",city:"",state:"",zipOrPostalCode:"",additionalAddress:""})},at=wk(),Ft=_k(),ve=async X=>{if(X.preventDefault(),!at||!Ft)return;const lt={name:e?e.displayName:`${I} ${b}`,email:e?e.email:T,address:Le.length?`${j}, ${Le}`:`${j}`},sn=await fetch("/.netlify/functions/create-payment-intent",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({amount:1e4,customerInformation:lt})}).then(zN=>zN.json());console.log(sn);const{paymentIntent:{client_secret:$n}}=sn;console.log($n);const wc=await at.confirmCardPayment($n,{payment_method:{card:Ft.getElement(Ek),billing_details:lt}});wc.error?alert(wc.error):wc.paymentIntent.status==="succeeded"&&(alert("Payment Successful!"),console.log(wc),En())};return S.useEffect(()=>{const X=lt=>{const sn=lt.target;t.current&&!t.current.contains(sn)&&i(!1)};return document.body.addEventListener("click",X),()=>document.body.removeEventListener("click",X)},[r]),S.useEffect(()=>{const X=VI.filter(lt=>lt.toLowerCase().includes(f.toLowerCase()));h(X)},[f,a]),S.useEffect(()=>{const X=lt=>{const sn=lt.target;n.current&&!n.current.contains(sn)&&s(!1)};return document.body.addEventListener("click",X),()=>document.body.removeEventListener("click",X)},[o]),w.jsxs(Toe,{children:[w.jsx(Ioe,{children:w.jsxs("form",{onSubmit:ve,children:[w.jsxs(Coe,{children:[w.jsx("label",{children:"Contact"}),w.jsx(Zr,{label:"Email",type:"email",name:"email",value:T,onChange:D,required:!0})]}),w.jsxs(xoe,{children:[w.jsx("label",{id:"delivery-label",children:"Delivery"}),w.jsxs(koe,{children:[w.jsx("label",{htmlFor:"countrySelect",onClick:H,children:"Select Country/Region"}),w.jsx(Aoe,{type:"button",onClick:H,children:u}),w.jsxs(Poe,{$isOpen:r,ref:t,children:[w.jsx(Ooe,{children:w.jsx(Noe,{type:"text",placeholder:"Search Countries...",value:f,onChange:ae})}),w.jsx($oe,{children:v.map(X=>w.jsx(Roe,{onClick:on,children:X},X))})]})]}),w.jsxs(Doe,{children:[w.jsx(Zr,{label:"First Name",type:"text",name:"firstName",value:I,onChange:D,required:!0}),w.jsx(Zr,{label:"Last Name",type:"text",name:"lastName",value:b,onChange:D,required:!0})]}),w.jsxs(Moe,{children:[w.jsx(Zr,{label:"Company (optional)",type:"text",name:"company",value:R,onChange:D}),w.jsx(Zr,{label:"Address",type:"text",name:"streetAddress",value:j,onChange:D,required:!0}),w.jsxs(Loe,{children:[w.jsx(Zr,{label:"City",name:"city",value:O,onChange:D,required:!0}),w.jsxs(joe,{children:[w.jsx("label",{onClick:se,children:"Select State"}),w.jsx(Voe,{onClick:se,children:m}),w.jsx(Foe,{$isOpen:o,ref:n,children:p.map(X=>w.jsx(Uoe,{onClick:st,children:X},X))})]}),w.jsx(Zr,{label:"Zip / Postal Code",name:"zipOrPostalCode",value:ye,required:!0})]}),w.jsxs(zoe,{children:[w.jsx(Boe,{onClick:$,className:"add",children:"+ Add appartment, suite, etc"}),w.jsx(Woe,{label:Be?"Apartment, suite, etc. (optional)":"",$isDisplayed:Be,type:"text",name:"additionalAddress",value:Le,onChange:D})]})]})]}),w.jsx(Koe,{})]})}),w.jsx(Xoe,{})]})},Zoe=()=>{const{setCategoriesMap:e}=S.useContext(H0);return S.useEffect(()=>{(async()=>{try{const n=await Nee();console.log("Logging categories map from App component!: ",n),e(n)}catch(n){console.log(n)}})()},[e]),w.jsx(u4,{children:w.jsxs(Mn,{path:"/",element:w.jsx(lte,{}),children:[w.jsx(Mn,{index:!0,element:w.jsx(Are,{})}),w.jsx(Mn,{path:"about",element:w.jsx(Ore,{})}),w.jsx(Mn,{path:"mentoring",element:w.jsx(Nre,{})}),w.jsx(Mn,{path:"contact",element:w.jsx($re,{})}),w.jsx(Mn,{path:"shop/:category",element:w.jsx(Jre,{})}),w.jsx(Mn,{path:"shop/:category/:id",element:w.jsx(loe,{})}),w.jsx(Mn,{path:"authentication",element:w.jsx(Gre,{})}),w.jsx(Mn,{path:"cart-summary",element:w.jsx(Eoe,{})}),w.jsx(Mn,{path:"checkout",element:w.jsx(Joe,{})})]})})};Eg.createRoot(document.getElementById("root")).render(w.jsx(q.StrictMode,{children:w.jsx(m4,{children:w.jsx(J4,{children:w.jsx(jee,{children:w.jsx(Bee,{children:w.jsx(yk,{stripe:Q4,options:X4,children:w.jsx(Zoe,{})})})})})})}))});export default ese();
